...
<div style="background:#f0fdf4;border:2px solid #059669;border-radius:8px;padding:16px;margin:24px 0;">
  ...
  <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:8px;">
    ...
    <li><a href="https://px.a8.net/svt/ejp?a8mat=4B7T8W+6YNKRU+1WW0+NXMIQ" rel="nofollow" style="display:inline-block;background:#1f2937;color:#fbbf24;padding:8px 16px;border-radius:6px;text-decoration:none;font-weight:bold;font-size:14px;">▶ 法人ETCの決定版【ETCブラックカード】</a><img border="0" width="1" height="1" src="https://www16.a8.net/0.gif?a8mat=4B7T8W+6YNKRU+1WW0+NXMIQ" alt=""></li>
